...
import { useThrottledUpdateParams, useDebouncedUpdateParams } from "@/features/parameter-editing";
...
import { SectionLabel, ValueLabel, SelectedLabel } from "./helpers";
...
export function ParameterPanel() {
  ...
  const setPreserveAspectRatio = useImageStore(
